...
struct receiver *init_receiver(char name, int num_ch, int ch_ofs, struct serial_state_t *serial, struct ipc_state_t *ipc, struct udp_state_t *udp)
{
	struct receiver *rx;
	...
	protodec_initialize(rx->decoder, serial, ipc, udp, name);
